...
export interface CarInsuranceRate extends Document {
  carBrand: string;
  carModel: string;
  subModel: string;
  year: number;
...
const carInsuranceSchema = new Schema<CarInsuranceRate>(
  {
...
export default model<CarInsuranceRate>("CarInsuranceRate", carInsuranceSchema);
